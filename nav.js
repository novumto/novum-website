(function () {
  ...
  style.textContent = [
    ...
    '.nv-footer{position:fixed;bottom:0;left:0;right:0;padding:16px 48px;display:flex;justify-content:center;gap:24px;align-items:center;font-size:13px;opacity:0.55;pointer-events:none;}',
    '.nv-footer a{pointer-events:auto;color:inherit;text-decoration:none;transition:opacity 0.2s;}',
    '.nv-footer a:hover{opacity:0.7;}',
    '@media(max-width:640px){.nv-footer{padding:16px 20px;font-size:12px;gap:16px;}}'
  ].join('');
