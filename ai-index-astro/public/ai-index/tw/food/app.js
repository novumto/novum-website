// ================================================================
// app.js — 互動邏輯 + Supabase 表單送出
// 修改說明：
//   - loadStores() 已移除（店家改由伺服器端渲染，爬蟲直接看得到）
//   - 表單送出成功後，關閉 Modal 時重新載入頁面，取得最新店家列表
// ================================================================
...
document.addEventListener('DOMContentLoaded', () => {
  // 注意：loadStores() 已移除。
  // 店家資料改由 Astro 伺服器端渲染，爬蟲打開就看得到完整內容。
